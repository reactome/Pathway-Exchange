...
/**
 * Layout generator producing SBML layout extension.
 * 
 * @author David Croft
 *
 */
public class LayoutGeneratorExtension extends LayoutGenerator {
	...
	public void run(Diagram diagram) {
		...
		layout.setDimensions(layout.createDimensions(diagram.getWidth(), diagram.getHeight()));
	...
	public String newBoundingBoxId() {
	...
	private void addReactionVertexLayout(ReactionVertex reactionVertexLayout) {
		...
		String sbmlReactionId = reactionVertexLayout.getSbmlReactionId();
	...
	private String addEntityVertexLayout(EntityVertex entityVertexLayout) {
		...
		speciesGlyphId = entityVertexLayout.getId();
	...
	private void addEdgeLayout(Edge edgeLayout, SpeciesReferenceGlyph speciesReferenceGlyph, String speciesGlyphId) {
		...
		speciesReferenceGlyph.setId(edgeLayout.getId());
	...
	private void addCompartmentLayout(CompartmentVertex compartmentVertexLayout) {
		...
		compartmentGlyph.setId(compartmentVertexLayout.getId());
